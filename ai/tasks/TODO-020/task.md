...
## Steps
- [ ] Step 1: Review human answers to questions in inbox_note.md
- [ ] Step 2: Based on human feedback, reorganize context documents using preferred approach
- [ ] Step 3: Update AI_README.md if folder structure changes
- [ ] Step 4: Ensure all references to context files are updated
- [ ] Step 5: Test that AI can access the new context structure effectively
...
- [Implementation approach chosen from the options presented]
