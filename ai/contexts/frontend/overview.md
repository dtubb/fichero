...
- **Development Standards**: `ai/contexts/frontend/development_standards.md`
- **Key Files**: `ai/contexts/frontend/key_files.md`
- **Workflow Checklist**: `ai/contexts/frontend/workflow_checklist.md`
