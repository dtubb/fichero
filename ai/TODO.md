...
- [>] TODO-018: Update TASK_WORKFLOW.md to be more concise with human review and Git steps (P1, Medium)
- [ ] TODO-019: Update context documents to reflect current application state (P1, Medium)