...
| `PairingBlocker` (#3769 fix) exists with 7 cases, each carrying its own headline/detail/action — but it is **`private`**, hence currently untestable | `fichero/fichero/Views/Settings/LibraryAccess/PairingCardView.swift:374-438` |
