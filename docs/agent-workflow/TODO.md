# Todo List to Manage Agent Tasks
...
1. **Check inbox first** - See `docs/agent-workflow/workflows/INBOX_WORKFLOW.md` for complete instructions
...
- [x] TODO-016: Implement agent workflow folder with TODO.md, README.md, and workflow docs
...
- [x] TODO-144: Implement Hugging Face Thinking Models Support (P1, High)
  ...
  - Documentation: archived outside repo in delete staging
...
- [x] TODO-105: Migrate High-Priority Services to Generated Client (P1, High)
  ...
  - See: docs/architecture/swiftui/api_migration_guide.md
