...
# Detect Segments (Apple Vision)

> 🤖 *AI Drafted (Not reviewed)*

Use this when: you want text bounding boxes on pages before (or without) transcription. On-device Apple Vision detects line and word regions and saves them per page — fast, local, free. For hard hands Apple can miss regions; try Detect Segments (VLM) with a vision model of your choice.
