...
2. Is `integration` a permanent branch, or created per-batch and deleted after it reaches `main`?
3. Worth a guardrail asserting no lane worktree is `ahead:0` and abandoned (auto-flag rot)?
