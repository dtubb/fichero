...
Every extracted item carries provenance: which page it came from, which workflow produced it, which model was used. You review the output — approve, reject, suppress, or merge any entity or claim — and suppression rules persist to future runs.
...
1. Install Tailscale on your Mac and on the device you want to connect from.
