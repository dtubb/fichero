...
| `detail` | string | basic | Detection detail. One of: count, basic, detailed. |
| `force_ocr` | boolean | no | Force image processing instead of existing text. |
| `include_expressions` | boolean | yes | Describe expressions. |
...
```text
Detect people/faces in this image.

Return as JSON:
{
    "count": <number>,
    "people": [
        {"position": "<left/center/right>", "description": "<brief description>", "expression": "<facial expression>"},
        ...
    ]
}
