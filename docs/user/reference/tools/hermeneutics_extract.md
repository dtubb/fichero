...
Extract interpretations section only.

| | |
| --- | --- |
| Tool id | `hermeneutics_extract` |
| Category | llm |
...
Task: Extract only interpretive claims the document itself supports. Name the interpreted theme, practice, or concept; split the interpretation into verb and object; include the shortest supporting source_text. Do not turn unstated speculation into fact.
