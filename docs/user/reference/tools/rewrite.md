...
| --- | --- | --- | --- |
| Text (`text`) | `text` | yes | Text to rewrite |
...
| `style` | string | concise | Writing style. One of: formal, casual, academic, concise, expanded, simplified, technical. |
| `target_language` | string | — | Translate to language. |
...
```text
Rewrite to be as concise as possible. Remove redundancy, keep only essential information.
