...
Extract legal references section only.

| | |
| --- | --- |
| Tool id | `legal_references_extract` |
| Category | llm |
...
Task: List every law, article, decree, statute, or legal reference cited. Name + predicate split into 'verb' + 'object' describing how it's invoked.
...
{"legal_references": [{"name": "...", "verb": "...", "object": "..."}]}
```
