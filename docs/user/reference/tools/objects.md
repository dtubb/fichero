...
| `detail_level` | string | basic | Detail level. One of: count, basic, detailed. |
| `force_ocr` | boolean | no | Force image processing instead of existing text. |
| `include_positions` | boolean | yes | Include positions. |
...
{
    "objects": [
        {"type": "<object type>", "count": <number>, "position": "<top-left/top-center/top-right/center-left/center/center-right/bottom-left/bottom-center/bottom-right>"}
    ],
