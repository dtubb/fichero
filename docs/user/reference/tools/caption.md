...
| `max_length` | integer | 15 | Max words. |
...
| `style` | string | neutral | Caption style. One of: neutral, descriptive, creative, technical. |
...
```text
Write a single-line caption for this image.

Write a factual, objective caption.
Keep it under 15 words. No punctuation at the end.
