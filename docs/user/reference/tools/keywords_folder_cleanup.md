...
# Clean Keywords (folder)

> 🤖 *AI Drafted (Not reviewed)*

Pick global canonical keywords across all pages in the folder and save a cleaned artifact on the folder doc.

| | |
| --- | --- |
| Tool id | `keywords_folder_cleanup` |
| Category | llm |
