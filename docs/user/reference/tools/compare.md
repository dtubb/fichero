...
| --- | --- | --- | --- |
| `aspects` | array | ["content", "style", "layout", "color"] | Aspects to compare. |
...
| `focus` | string | both | Comparison focus. One of: differences, similarities, both, changes. |
...
Describe both similarities and differences.

Consider these aspects: content, style, layout, color
