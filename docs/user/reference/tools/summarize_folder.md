...
Generate a summary of all documents in a folder

| | |
| --- | --- |
| Tool id | `summarize_folder` |
| Category | llm |
...
| --- | --- | --- | --- |
| Texts (`texts`) | `array` | yes | Array of text contents |
| Folder ID (`folder_id`) | `text` | no | Folder document ID |
...
| `style` | string | detailed | Style. One of: brief, detailed, bullets. |
