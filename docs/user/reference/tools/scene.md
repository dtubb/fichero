...
| `include_details` | boolean | yes | Include scene details. |
...
| `scenes` | array | ["indoor", "outdoor_urban", "outdoor_nature", "studio", "aerial", "underwater", "abstract", "document", "screenshot"] | Scene categories. |
...
```text
Classify the scene/environment in this image.

Choose ONE primary scene type from: indoor, outdoor_urban, outdoor_nature, studio, aerial, underwater, abstract, document, screenshot
