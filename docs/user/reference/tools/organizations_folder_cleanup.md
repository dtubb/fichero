...
# Clean Organizations (folder)

> 🤖 *AI Drafted (Not reviewed)*

Pick global canonical organizations across all pages in the folder and save a cleaned artifact on the folder doc.

| | |
| --- | --- |
| Tool id | `organizations_folder_cleanup` |
| Category | llm |
