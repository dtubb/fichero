...
Extract properties section only.

| | |
| --- | --- |
| Tool id | `properties_extract` |
| Category | llm |
...
Task: List every property, estate, parcel, building, or farm mentioned that is not already a river or mine. Name + predicate split into 'verb' + 'object'.
