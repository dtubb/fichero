...
| --- | --- | --- | --- |
| Text (`text`) | `text` | yes | Source text |
...
| `question_type` | string | mixed | Question type. One of: factual, analytical, discussion, comprehension, mixed. |
...
```text
Generate 10 questions based on this text.

Generate a mix of factual, analytical, and discussion questions.
