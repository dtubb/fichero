...
| --- | --- | --- | --- |
| `categories` | array | ["violence", "adult", "drugs", "hate", "self_harm"] | Safety categories to check. |
...
| `threshold` | string | moderate | Sensitivity level. One of: strict, moderate, permissive. |
...
```text
Assess the content safety of this image.

Check for these categories: violence, adult, drugs, hate, self_harm

Flag content that would be inappropriate for general audiences.
