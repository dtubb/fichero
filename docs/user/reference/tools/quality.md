...
| --- | --- | --- | --- |
| `aspects` | array | ["sharpness", "exposure", "noise", "composition", "color_balance"] | Quality aspects to assess. |
...
| `scale` | string | 1-10 | Rating scale. One of: 1-5, 1-10, percentage. |
...
Evaluate these aspects: sharpness, exposure, noise, composition, color_balance

Rate each aspect from 1 (poor) to 10 (excellent). Also provide an overall quality score.
