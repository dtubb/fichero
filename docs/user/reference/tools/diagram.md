...
| `diagram_type` | string | generic | Diagram type. One of: flowchart, org_chart, network, timeline, mind_map, generic. |
| `force_ocr` | boolean | no | Force image processing instead of existing text. |
| `include_labels` | boolean | yes | Extract text labels. |
...
- Extract all text labels exactly as written
