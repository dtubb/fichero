...
> these corrections:
> - **Tasks are tracked in GitHub Issues + Milestones**, not a local TODO file
...
>   `docs/contributor_manual/swiftui-development-standards.md`.
...
- [ ] Check the assigned GitHub issue for task details
...
1. Read the assigned GitHub issue for task details
...
8. Update the GitHub issue status
...
### Doc Locations
- `docs/contributor_manual/architecture/fichero/overview.md` - High-level architecture
- `docs/contributor_manual/architecture/fichero/key_files.md` - File organization
- `docs/contributor_manual/swiftui-principles.md` - Code patterns
- `docs/contributor_manual/swiftui-development-standards.md` - Standards and guidelines
- `docs/contributor_manual/architecture/fichero/workflow_checklist.md` - This file
...
- Frontend Docs: `docs/contributor_manual/architecture/fichero/`
