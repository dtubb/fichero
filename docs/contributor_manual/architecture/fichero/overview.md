...
**AI Providers** (`Views/Settings/AI/AIProviders/`):
...
- **Development Standards**: `docs/contributor_manual/swiftui-development-standards.md`
- **Key Files**: `docs/contributor_manual/architecture/fichero/key_files.md`
- **Workflow Checklist**: `docs/contributor_manual/architecture/fichero/workflow_checklist.md`
