...
- Audited mutation path / action registry: `docs/contributor_manual/architecture/action_layer.md`
- API/backend architecture: `docs/contributor_manual/architecture/fichero-server/overview.md`
- AI infrastructure and model policy: `docs/contributor_manual/architecture/ai_infrastructure.md`
- Image editing backend strategy: `docs/contributor_manual/architecture/image_editing_backend_strategy.md`
- Pi in-app agent harness: `docs/contributor_manual/architecture/pi_agent_harness.md`
- MLX/on-device agent service boundary: `docs/contributor_manual/architecture/mlx_on_device_agent.md`
- Workflow multi-pass engine primitives: `docs/contributor_manual/architecture/workflow_multi_pass_engine.md`
- SwiftUI/frontend architecture: `docs/contributor_manual/architecture/fichero/overview.md`
- SwiftUI principles: `docs/contributor_manual/swiftui-principles.md`
