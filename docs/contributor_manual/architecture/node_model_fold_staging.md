...
- `docs/contributor_manual/architecture/fichero/mac_shell_design_proposal.md` + `agents/ROADMAP.md` line 37 — the Mac UI reform this foundation enables.