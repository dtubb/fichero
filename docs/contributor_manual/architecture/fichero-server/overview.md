...
- `docs/contributor_manual/architecture/fichero-server/capture_sessions_resumable_upload_contract.md` — mobile/offline capture session and resumable-upload contract slice (`#2352`)
