...
*Sources:* `docs/contributor_manual/` *top-level pages,* `CONTRIBUTING.md`*, and* `AGENTS.md`*, consolidated and corrected against the code on the* `integration` *branch, 2026-08-27.*
