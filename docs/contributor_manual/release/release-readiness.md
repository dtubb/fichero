...
runbook with full detail: `docs/contributor_manual/release/release-lane.md`.
...
| `docs/contributor_manual/release/sparkle-release.md` | ⚠️ STALE doc | still cites the old `fichero-releases` feed + a `0.0.1` placeholder key story; superseded by `release-lane.md`. |
