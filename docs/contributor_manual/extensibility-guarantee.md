...
This backend treats new extraction outputs as additive in 0.0.x. The contract test is [test_extensibility_guarantee.py](fichero-server/tests/contracts/test_extensibility_guarantee.py).
