"""
ZIP Manager for Fichero Library

Handles downloading, extracting, and importing ZIP files from URLs,
including intelligent handling of OneDrive/SharePoint links.
"""
...
class ZipManager:
    """Manages ZIP file downloads, extraction, and import into library"""
    ...
    async def import_from_url(
        ...
        """
        Download ZIP from URL, extract, import into library, and delete ZIP

        Args:
            url: URL to ZIP file (supports OneDrive/SharePoint links)
        ...
        Returns:
            Dict with import statistics and collection_id
        """
        temp_zip_path = None
        temp_extract_dir = None

        try:
            logger.info(f"Starting ZIP import from URL: {url}")
            ...
            logger.info(f"ZIP import completed successfully: {result}")
            return result
