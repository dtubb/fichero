...
class StateManager:
    ...
    def _get_state_file_path(self) -> Path:
        ...
        try:
            ...
            # Fallback to standard Application Support location
            from fichero.storage import settings as storage_settings
            storage_settings.base_path.mkdir(parents=True, exist_ok=True)
            return storage_settings.base_path / "app_state.json"
