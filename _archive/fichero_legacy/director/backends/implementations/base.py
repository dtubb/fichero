...
class FolderTask:
    ...
    library_item_id: str = None  # Library item_id of folder being processed
    library_collection_id: str = None  # Library collection_id
    library_item_map: Dict = None  # filename -> item_id mapping for file-level routing

    def __post_init__(self):
        if self.variables is None:
            self.variables = {}
        if self.library_item_map is None:
            self.library_item_map = {}
...
def create_folder_task(folder_path: Path, output_path: Path, plan_config: Dict,
                      ...
                      library_item_map: Dict = None) -> FolderTask:
