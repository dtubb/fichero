...
def get_deepseek_key(cli_arg: Optional[str] = None) -> Optional[str]:
    """Get DeepSeek API key with fallback hierarchy"""
    return get_api_key("deepseek", cli_arg)


def get_groq_key(cli_arg: Optional[str] = None) -> Optional[str]:
    """Get Groq API key with fallback hierarchy"""
    return get_api_key("groq", cli_arg)


def get_together_key(cli_arg: Optional[str] = None) -> Optional[str]:
    """Get Together AI API key with fallback hierarchy"""
    return get_api_key("together", cli_arg)
