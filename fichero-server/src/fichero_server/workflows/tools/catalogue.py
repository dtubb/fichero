...
from fichero_server.llm import LLMConfig, chat_with_fallback
from fichero_server.db import db_manager
from fichero_server.models import Document, DocType, Artifact
...
def _build_prompt(output_language: str) -> str:
    ...
    not the extraction.
    """
    from fichero_server.llm.prompts import load_prompt
    return load_prompt(
        "catalogue", "narrative",
...
async def catalogue(
    ...
    if inputs.get("hitl_on_ambiguous_grouping", False):
        ...
        if _grouping_is_ambiguous(groups, min_items=min_items):
            ...
            from fichero_server.workflows.human_review import ask_human
