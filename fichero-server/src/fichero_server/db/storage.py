...
Usage:
    from fichero_server.db.storage import settings, ensure_thumbnail, resolve_source
...
def resolve_source(
    ...
    if bookmark_data := _get_bookmark(doc):
        try:
            from fichero_server.bookmarks import is_available as bookmarks_available
...
def _resolve_pdf_render_source(
    ...
    *,
    ...
    """
    from fichero_server.models import Document as DocumentModel, DocType, FileType
...
from fichero_server.db.storage_snapshots import (  # noqa: F401, E402 (re-exported)
