...
async def storage_stats(
    ...
    from fichero_server.db.storage import stats
...
async def regenerate_missing_thumbnails(
    ...
    """
    from fichero_server.db.storage import get_thumbnail, ensure_thumbnail
...
async def debug_document_paths(
    ...
    from fichero_server.db.storage import resolve_source, _thumb_path
...
async def pin_snapshot(
    ...
    from fichero_server.db.storage import _load_all_snapshot_records, _save_snapshot_record
