...
# `fichero_server.api.routes.kg_render.<name>`. Two things must both hold:
...
def chat(*args, **kwargs):
    """Passthrough to fichero_server.llm.chat; imports it on first call (#3950)."""
    from fichero_server.llm import chat as _impl  # noqa: PLC0415
