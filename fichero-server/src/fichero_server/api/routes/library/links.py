...
:class:`fichero_server.models.knowledge.ClaimRelationType` and mirrors the shape of
:class:`fichero_server.models.knowledge.KnowledgeClaimLink`, but connects any two
