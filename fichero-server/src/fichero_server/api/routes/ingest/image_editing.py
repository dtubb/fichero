...
from fichero_server.api.routes.workflow.batch import BatchResponse, get_batch_manager
...
def _apply_operation(image: Image.Image, op: dict[str, Any]) -> Image.Image:
    ...
    # fichero_server.media.image_ops; the return above is the sole runtime path.
