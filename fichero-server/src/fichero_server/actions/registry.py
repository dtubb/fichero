...
See ``docs/contributor_manual/architecture/action_layer.md``. The shapes here are the interface
...
``invoke`` contract:
  ...
  4. write an :class:`fichero_server.models.ActionAudit` row — **NOT best-effort**
...
class ChangeSpec:
    ...
    single :class:`fichero_server.api.change_stream.ChangeEvent`; carrying every touched
...
class ActionRegistry:
    ...
    def invoke(
        ...
        *,
        ...
        """
        from fichero_server.actions.audit_chain import save_chained_audit
        from fichero_server.models import ActionAudit  # local import: avoid cycle at module load
