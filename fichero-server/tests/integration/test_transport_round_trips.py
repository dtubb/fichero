...
ENGINE_SRC = REPO_ROOT / "fichero-server" / "src"
...
def uds_engine():
    ...
    engine = _spawn(
        ...
        # transport marker. Serving fichero_server.api.main directly over a socket
        # makes every request read as non-loopback and 403 — a false failure.
        ["fichero_server.api.uds_transport:app", "--uds", str(sock)],
