...
class TestIngestPipelineIntegration:
    ...
    def test_nested_folder_docs_are_persisted(self, tmp_path):
        ...
        try:
            ...
            with patch("fichero_server.bookmarks.create_bookmark", return_value=b"bookmark_data"):
                docs = ingest_folder(
                    test_folder,
    ...
    def test_failed_bookmark_only_marks_that_file_failed(self, tmp_path):
        ...
        try:
            ...
            with patch("fichero_server.bookmarks.create_bookmark", side_effect=_bookmark):
                docs = ingest_folder(
                    test_folder,
                    mode=IngestMode.LINK,
                    create_collection=False,
    ...
    def test_copy_mode_uses_package_files_directory(self, tmp_path):
        ...
        try:
            ...
            with patch("fichero_server.bookmarks.create_bookmark", return_value=b"bookmark_data"):
                ...
                with patch("fichero_server.importers.ingest._try_apfs_clone", side_effect=_fake_clone) as mock_clone:
                    docs = ingest_folder(
                        test_folder,
