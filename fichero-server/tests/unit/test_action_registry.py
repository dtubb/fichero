...
from fichero_server.actions.registry import ActionContext, ChangeSpec, registry
...
def dummy_action():
    ...
    from fichero_server.actions.registry import ActionRegistration
...
class TestRegistryInvoke:
    ...
    def test_invoke_unknown_action_raises(self, db):
        from fichero_server.actions.registry import ActionNotFoundError
