...
from fichero_server.models.knowledge import KnowledgeClaim, QuotationKind
...
class TestSaveClaimAutoAttribution:
    ...
    def test_missing_source_document_warns_without_substitution(self, caplog):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            caplog.set_level(logging.WARNING, logger="fichero_server.workflows.tools._entity_writer")
            claim_id = save_claim(
                db,
                text="Pedro owned the mine.",
