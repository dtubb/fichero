...
from fichero_server.models.knowledge import KnowledgeEntity, KnowledgeClaim, EntityType
from fichero_server.llm.multilingual import detect_language, normalize_text, stem_text
...
class TestCrossLanguageMatching:
    ...
    def test_calculate_similarity_same_language(self):
        ...
        from fichero_server.llm.multilingual import calculate_cross_language_similarity
