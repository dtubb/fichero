...
def test_get_model_cost_returns_known_cloud_model_cost() -> None:
    ...
    with patch("fichero_server.llm.model_types._get_litellm", return_value=fake_litellm):
...
def test_get_model_cost_returns_none_for_incomplete_pricing_and_logs() -> None:
    ...
    with (
        patch("fichero_server.llm.model_types._get_litellm", return_value=fake_litellm),
