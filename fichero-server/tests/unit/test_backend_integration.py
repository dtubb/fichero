...
class TestIngestWithTextExtraction:
    ...
    def test_ingest_file_extract_text(self, tmp_path):
        ...
        with patch('fichero_server.loaders.load_media', mock_load_media):
    ...
    def test_ingest_file_skips_non_extractable(self, tmp_path):
        ...
        with patch('fichero_server.db.db') as mock_db:
            ...
            with patch('fichero_server.loaders.load_media') as mock_loader:
                ingest_file(
                    test_file,
...
class TestKeychainRubicon:
    ...
    def test_keychain_uses_security_command(self):
        ...
        import fichero_server.security.keychain as keychain
    ...
    def test_keychain_is_available_check(self):
        ...
        from fichero_server.security.keychain import is_available
...
class TestBookmarksIntegration:
    ...
    def test_ingest_link_mode_creates_bookmark(self, tmp_path):
        ...
        with patch('fichero_server.bookmarks.create_bookmark', return_value=b"fake_bookmark"):
            with patch('fichero_server.db.db') as mock_db:
                mock_db.save = MagicMock()
    ...
    def test_ingest_copy_mode_no_bookmark(self, tmp_path):
        ...
        with patch('fichero_server.importers.ingest._copy_to_library', return_value=tmp_path / "copy.jpg"):
            with patch('fichero_server.db.db') as mock_db:
                mock_db.save = MagicMock()
