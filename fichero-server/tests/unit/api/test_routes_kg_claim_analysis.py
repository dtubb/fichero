...
from fichero_server.api.routes import kg_claim_analysis as routes
from fichero_server.models.knowledge import ClaimRelationType, KnowledgeClaim, KnowledgeClaimLink
