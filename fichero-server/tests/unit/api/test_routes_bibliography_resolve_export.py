...
``fichero_server.bibliography.doi_lookup`` (the route imports them locally, so patching
...
import fichero_server.bibliography.doi_lookup as doi_lookup
from fichero_server.bibliography.importers import read_bibtex
