...
from fichero_server.api.routes import search as search_routes
from fichero_server.models.knowledge import ClaimType, EntityType
from fichero_server.db import SearchAnchor, SearchExcerpt, SearchResult
from fichero_server.models.knowledge import KnowledgeClaim, KnowledgeEntity
from fichero_server.models import AccountUser, DocType, Document, FileType, KGGraphListResponse, SavedSearch
...
class TestEnhancedSearch:
    def test_entity_match_lookup_failure_degrades_to_no_hits(self, db, monkeypatch):
        from fichero_server.api.routes.search import _entity_match_results
    ...
    def test_pdf_file_projection_batches_page_lookups(self, client, db, monkeypatch):
        from fichero_server.db import Database, SearchResult
...
class TestSearchFailureSurfacing:
    ...
    def test_db_search_raises_typed_error_on_internal_failure(self, db, monkeypatch):
        from fichero_server.db import Database, SearchExecutionError
    ...
    def test_failed_search_returns_500_not_empty_200(self, client, monkeypatch):
        from fichero_server.db import SearchExecutionError
...
class TestSearchQueryAction:
    ...
    def test_appears_in_the_chat_tool_surface(self):
        from fichero_server.actions.chat_tools import action_tools
...
class TestQueryCompilation:
    ...
    def test_compiled_query_drives_retrieval_and_is_returned(self, client, db, monkeypatch):
        from fichero_server.retrieval.query_compiler import CompiledQuery
        from fichero_server.api.routes.search import core as core_module
