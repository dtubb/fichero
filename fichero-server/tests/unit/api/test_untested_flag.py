...
# interpret joined 2026-08-12: hermeneutic layer first writer, covered
# by tests/unit/workflows/test_interpret_tool.py.
HTR_TOOLS = {"files", "transcribe", "transcribe_review", "search", "detect_regions", "interpret"}
