...
class TestProviderCatalog:
    ...
    def test_local_providers(self):
        ...
        from fichero_server.llm.providers import get_local_providers
    ...
    def test_cloud_providers(self):
        ...
        from fichero_server.llm.providers import get_cloud_providers
    ...
    def test_get_provider_info(self):
        ...
        from fichero_server.llm.providers import get_provider_info, ProviderType
    ...
    def test_vision_providers(self):
        ...
        from fichero_server.llm.providers import get_vision_providers
    ...
    def test_embedding_providers(self):
        ...
        from fichero_server.llm.providers import get_embedding_providers
...
class TestAPIKeyResolution:
    ...
    def test_get_api_key_from_keychain(self):
        ...
        with patch("fichero_server.security.keychain.get_api_key") as mock_keychain:
...
class TestProviderAPIRoutes:
    ...
    def test_list_models_preserves_unknown_pricing_without_marking_free(self, client):
        ...
        with patch("fichero_server.llm.list_models_for_provider", return_value=fake_models):
            response = client.get("/api/providers/models/openai")
...
class TestProviderRefs:
    ...
    def test_save_and_get_provider_ref(self, db):
        ...
        from fichero_server.models import ProviderRef
...
class TestCollapseDuplicateProviders:
    ...
    def test_collapses_duplicates_by_name_and_type(self, app_db, monkeypatch):
        ...
        monkeypatch.setattr(
            "fichero_server.db.app.get_app_db", lambda: app_db, raising=False
        )
    ...
    def test_reparent_model(self, app_db):
        ...
        from fichero_server.models import Provider, ProviderType, Model
...
class TestCapabilityDerivation:
    ...
    def _registry(rows):
        return patch(
            "fichero_server.llm.list_models_for_provider",
            return_value=rows,
        )
