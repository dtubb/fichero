...
class TestIngestMode:
    ...
    def test_enum_values(self):
        ...
        from fichero_server.importers.ingest import IngestMode
...
class TestIffySidecar:
    def test_parse_iffy_sidecar_maps_fields_and_notes(self, tmp_path):
        from fichero_server.importers.ingest import _parse_iffy_sidecar
...
class TestIngestFile:
    ...
    @patch("fichero_server.db.db")
    @patch("fichero_server.importers.ingest._copy_to_library")
    ...
    def test_copy_rollback_removes_unreferenced_library_bytes(
        ...
        with patch(
            "fichero_server.importers.ingest._extract_file_metadata",
...
class TestIngestFolder:
    ...
    def test_link_file_changing_during_ingest_becomes_failed_stub(
        ...
        with patch(
            "fichero_server.importers.ingest._file_checksum",
    ...
    def test_large_folder_ingests_every_file_once(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("fichero_server.importers.ingest.ingest_file", fake_ingest_file)
...
class TestCopyToLibrary:
    ...
    @patch("fichero_server.importers.ingest._try_apfs_clone")
    @patch("fichero_server.db.storage.settings")
    ...
    @patch("fichero_server.importers.ingest._try_apfs_clone", return_value=False)
...
class TestTryApfsClone:
    ...
    def test_clones_file_on_same_volume(self, tmp_path):
        ...
        from fichero_server.importers.ingest import _try_apfs_clone
...
class TestIngestWithRealFiles:
    ...
    def test_pillow_registered_archival_image_formats_load(self, tmp_path, suffix, format_name):
        ...
        from fichero_server.loaders.image_loader import ImageLoader
...
class TestExtractFileMetadata:
    ...
    def test_extracts_file_size(self, tmp_path):
        ...
        from fichero_server.importers.ingest import _extract_file_metadata
    ...
    def test_rejects_oversized_image_metadata(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("fichero_server.loaders.image_loader._MAX_IMAGE_PIXELS", 4)
...
class TestIntegration:
    ...
    def test_complete_ingestion_workflow(self, tmp_path):
        ...
        with patch("fichero_server.db.db") as mock_db:
            mock_db.save.return_value = None
            mock_db.get.return_value = None
            
            # Mock file operations
            with patch("fichero_server.importers.ingest.shutil") as mock_shutil:
...
class TestTextExtraction:
    ...
    def test_pdf_creates_page_children_with_named_page_labels(self, tmp_path):
        ...
        """
        from fichero_server.importers.ingest import ingest_file, IngestMode
        from fichero_server.models import FileType, DocType
    ...
    def test_text_extraction_error_handling(self):
        ...
        with patch("fichero_server.db.db") as mock_db:
            ...
            with patch("fichero_server.bookmarks.create_bookmark") as mock_bookmark:
                ...
                with patch("fichero_server.loaders.load_media") as mock_load:
...
class TestTouchAncestorDocumentsCycleGuard:
    ...
    def test_cyclic_parent_chain_terminates(self):
        ...
        from fichero_server.importers.ingest import _touch_ancestor_documents
        from fichero_server.models import Document, DocType
