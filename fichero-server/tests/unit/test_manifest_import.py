...
from fichero_server.importers.manifest_import import import_manifest, validate_nodes
...
def test_resolve_ingest_mode_and_legacy_alias():
    ...
    from fichero_server.importers.manifest_import import resolve_ingest_mode
...
def test_group_node_maps_to_folder_doc_type():
    ...
    from fichero_server.importers.manifest_import import _NODE_TYPE_TO_DOC_TYPE, document_payload
...
def test_move_refuses_to_delete_network_source(tmp_path, monkeypatch):
    ...
    import fichero_server.importers.manifest_import as mi
...
def test_is_safe_to_delete_source_rules():
    ...
    from fichero_server.importers.manifest_import import _is_safe_to_delete_source
