...
def test_import_annotations_records_structured_skip_reasons():
    from fichero_server.importers.iiif_import import _import_annotations
...
def test_cli_import_iiif_invokes_importer(monkeypatch, tmp_path):
    ...
    def fake_import(**kwargs):
        ...
        from fichero_server.importers.iiif_import import IIIFImportSummary
    ...
    monkeypatch.setattr("fichero_server.importers.iiif_import.import_iiif_via_http", fake_import)
    runner = CliRunner()
