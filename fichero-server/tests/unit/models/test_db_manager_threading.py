...
from fichero_server.db.manager import DatabaseManager  # noqa: E402
from fichero_server.models import Document, DocType  # noqa: E402
...
def test_initialization_failure_is_loud_and_does_not_leave_a_cached_handle(
    ...
    monkeypatch.setattr(
        "fichero_server.workflows.default_workflows.seed_default_workflows", fail_seed
    )
    try:
