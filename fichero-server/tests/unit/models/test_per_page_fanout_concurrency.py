...
``fichero_server.workflows.tools.llm_base.save_artifact`` / ``find_existing_artifact``.
...
class TestPerPageFanOutConcurrency:
    ...
    def test_vision_wrapper_forwards_document_kwarg(self, temp_library):
        ...
        """
        from fichero_server.workflows.tools.vision_base import save_artifact as vision_save_artifact
        from fichero_server.models import Artifact
