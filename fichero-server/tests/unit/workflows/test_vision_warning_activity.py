...
from fichero_server.workflows.tools.vision_base import _log_vision_warning
...
class TestLogVisionWarning:
    ...
    _TRACKER_PATCH = "fichero_server.workflows.activity.get_activity_tracker"
...
class TestAppleVisionOCREmitsWarning:
    ...
    def test_import_error_calls_log_vision_warning(self, tmp_path):
        ...
        with (
            patch("fichero_server.workflows.tools.vision_base._log_vision_warning"),
            patch(
                "fichero_server.workflows.tools.vision_base.objc",
