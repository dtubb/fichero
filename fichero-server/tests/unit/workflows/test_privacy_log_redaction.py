...
from fichero_server.workflows.tools.extract import _parse_json_response
from fichero_server.workflows.tools.classify_script import classify_script
...
async def test_classify_script_parse_failure_logs_identifier_not_payload(caplog) -> None:
    ...
    with patch(
        "fichero_server.workflows.tools.classify_script.process_vision",
