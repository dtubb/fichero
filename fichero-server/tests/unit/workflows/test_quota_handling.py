...
Unit tests for two fixes in commit 4a6622fc (#1222):
  ...
  Fix 1: _is_quota_error() in fichero_server.workflows.builder
    — detects non-retriable quota/rate-limit errors so the workflow can
      pause immediately instead of burning retries.

  Fix 2: Defensive to_dict() in fichero_server.workflows.activity_types.Activity
...
from fichero_server.workflows.builder import _is_quota_error
from fichero_server.workflows.activity_types import Activity, ActivityType, ActivityLevel
