...
from fichero_server.workflows.tools.agent import react_agent
...
,
    ...
    with patch(
        "fichero_server.workflows.tools.agent.chat_workflow",
...
async def test_react_agent_with_tools():
    ...
    with patch("fichero_server.workflows.tools.agent.get_tool") as mock_get_tool:
        with patch("fichero_server.workflows.registry.TOOL_DEFS") as mock_tool_defs:
            ...
            from fichero_server.workflows.types import ToolDef, PortDef, DataType
...
async def test_react_agent_tool_not_found():
    ...
    with patch("fichero_server.workflows.tools.agent.get_tool", return_value=None):
        with patch(
            "fichero_server.workflows.tools.agent.chat_workflow",
