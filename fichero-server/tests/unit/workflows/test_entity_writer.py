...
class TestClaimHelperFunctions:
    def test_same_structured_claim_normalizes_entity_order_and_svo_noise(self):
        from fichero_server.workflows.tools._entity_writer import _same_structured_claim
...
class TestStage4RaceRecovery:
    ...
    def test_race_recovery_merges_duplicates(self, db, monkeypatch):
        ...
        from datetime import datetime, timedelta
        from fichero_server.workflows.tools import _entity_writer
        from fichero_server.workflows.tools._entity_writer import upsert_entity
...
class TestAdminQualifierHelpers:
    ...
    def test_qualifier_match_positive(self):
        from fichero_server.workflows.tools._entity_writer import _admin_qualifier_match
...
class TestAccentFoldingHelpers:
    ...
    def test_fold_accents_strips_diacritics(self):
        from fichero_server.workflows.tools._entity_writer import _fold_accents
    ...
    def test_normalized_claim_svo_key_collapses_surface_variants(self):
        from fichero_server.workflows.tools._entity_writer import _normalized_claim_svo_key
...
class TestFuzzyMatchAccentAware:
    ...
    def test_accent_variant_matches(self):
        ...
        # them identical.
        from fichero_server.workflows.tools._entity_writer import _fuzzy_match_existing
...
class TestLexicalAgreementGate:
    ...
    def test_accent_variant_agrees(self):
        from fichero_server.workflows.tools._entity_writer import _lexical_agreement
