...
from fichero_server.workflows.builder import SystemicErrorDetected, _make_node_function
from fichero_server.workflows.types import InputMapping, NodeDef
...
async def test_background_runner_marks_systemic_failures_failed(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("fichero_server.db.manager.db_manager.close_current_thread", lambda: None)
