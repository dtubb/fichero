from fichero_server.workflows.tools.clean_text import build_clean_text_prompt
...
def test_clean_text_prompt_mentions_reflow_by_default() -> None:
    prompt = build_clean_text_prompt({})
    assert "hard-wrapped" in prompt
