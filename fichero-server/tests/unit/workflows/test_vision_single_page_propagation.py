...
async def test_propagate_single_page_writes_page_content():
    ...
    with patch("fichero_server.db.db_manager") as mock_db_manager:
...
async def test_propagate_blank_single_page_skips_save():
    ...
    with patch("fichero_server.db.db_manager") as mock_db_manager2:
...
async def test_propagate_non_blank_written_blank_skipped():
    ...
    with patch("fichero_server.db.db_manager") as mock_db_mgr:
