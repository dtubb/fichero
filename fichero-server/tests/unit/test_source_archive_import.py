...
from fichero_server.importers.source_archive_import import (
...
def test_cli_import_newton_marshall_invokes_importer(monkeypatch, tmp_path):
    ...
    def fake_import(client, **kwargs):
        ...
        from fichero_server.importers.source_archive_import import SourceArchiveImportSummary
    ...
    monkeypatch.setattr(
        "fichero_server.importers.source_archive_import.import_newton_marshall_diary_via_http",
        fake_import,
    )
    runner = CliRunner()
...
def test_cli_import_istmina_mineria_invokes_http_importer(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "fichero_server.importers.source_archive_import.import_istmina_mineria_via_http",
        fake_import,
    )
    runner = CliRunner()
    result = runner.invoke(
...
def test_cli_import_archivo_judicial_invokes_importer(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "fichero_server.importers.source_archive_import.import_archivo_judicial_medellin_via_http",
        fake_import,
    )
    runner = CliRunner()
    result = runner.invoke(
...
def test_cli_import_ghc_catalogued_materials_invokes_importer(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "fichero_server.importers.source_archive_import.import_ghc_catalogued_materials_via_http",
        fake_import,
    )
    runner = CliRunner()
    result = runner.invoke(
...
def test_cli_import_chota_colombian_pacific_maps_invokes_importer(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "fichero_server.importers.source_archive_import.import_chota_colombian_pacific_maps_via_http",
        fake_import,
    )
    runner = CliRunner()
    result = runner.invoke(
