...
class TestIsAvailable:
    ...
    def test_returns_bool(self):
        ...
        from fichero_server.bookmarks import is_available
    ...
    def test_true_when_rubicon_available(self):
        ...
        from fichero_server.bookmarks import is_available, _HAS_RUBICON
...
class TestCreateBookmark:
    ...
    def test_create_for_existing_file(self, tmp_path):
        ...
        from fichero_server.bookmarks import create_bookmark, is_available
...
class TestResolveBookmark:
    ...
    def test_none_input_returns_none(self):
        ...
        from fichero_server.bookmarks import resolve_bookmark
    ...
    def test_roundtrip(self, tmp_path):
        ...
        from fichero_server.bookmarks import create_bookmark, resolve_bookmark, is_available
...
class TestStopAccessing:
    ...
    def test_no_error_for_regular_file(self, tmp_path):
        ...
        from fichero_server.bookmarks import stop_accessing
...
class TestIsBookmarkStale:
    ...
    def test_none_is_stale(self):
        ...
        from fichero_server.bookmarks import is_bookmark_stale
    ...
    def test_valid_bookmark_not_stale(self, tmp_path):
        ...
        from fichero_server.bookmarks import (
            create_bookmark,
            is_bookmark_stale,
            is_available,
        )
...
class TestBookmarkAccess:
    ...
    def test_context_manager_with_none(self):
        ...
        from fichero_server.bookmarks import BookmarkAccess
