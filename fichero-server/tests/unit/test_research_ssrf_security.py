...
To run: pytest fichero-server/tests/unit/test_research_ssrf_security.py -v
"""
...
from fichero_server.workflows.tools.research import research_browser_navigate, research_document_fetch
