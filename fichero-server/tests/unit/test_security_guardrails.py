...
PERSISTENCE_PATH_ALLOWLIST = frozenset(
    {
        # fichero_server.db was split into a package (#2566): the real persistence
...
def test_xml_parsing_stays_inside_xml_security_chokepoint() -> None:
    ...
    lines = [
        ...
        "Route all XML parsing through fichero_server.security.xml_security instead.",
        "",
...
def test_wildcard_bind_host_is_never_used_outside_sanctioned_guards() -> None:
    ...
    lines = [
        ...
        "Use fichero_server.security.bind_host.resolve_bind_host and only mention 0.0.0.0 inside",
