...
from fichero_server.importers.slipbox_import import (
...
def test_cli_import_slipbox_invokes_importer(monkeypatch, tmp_path):
    ...
    def fake_import_slipbox(_client, **kwargs):
        from fichero_server.importers.slipbox_import import SlipboxImportSummary
    ...
    monkeypatch.setattr(
        "fichero_server.importers.slipbox_import.import_slipbox_via_http",
        fake_import_slipbox,
    )
