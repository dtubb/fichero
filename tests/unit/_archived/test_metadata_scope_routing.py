...
class TestMetadataScopeRouting(unittest.TestCase):
    ...
    def test_integration_end_to_end(self):
        ...
        def mock_extract(output_path, output_type, collection_id, item_id, processing_output_id, step_name, workflow_manifest=None, model_name=None, provider_name=None):
            metadata_list = []
