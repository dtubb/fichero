"""
Unit tests for ListWidget widget.
...
from src.fichero.shared.widgets import ListWidget, Platform


class TestListWidget(unittest.TestCase):
    """Test ListWidget platform detection and data handling."""
    ...
    def test_platform_detection_macos(self):
        ...
        tree_list = ListWidget(headings=['Name'])
    ...
    def test_clear(self):
        """Test clearing data."""
        tree_list = ListWidget(headings=['Name'], data=self.sample_data)
        tree_list.clear()
    ...
    def test_selection_callback(self):
        ...
        callback = Mock()
        tree_list = ListWidget(headings=['Name'], on_select=callback)
