...
class TestDirectorLibraryIntegration(unittest.TestCase):
            ...
            "steps": [
                {
                    ...
                    "output_scope": "file"  # Transcriptions are file-level
                },
                {
                    "order": 2,
                    "name": "catalogue",
                    ...
                    "output_scope": "file"  # Single file catalogue
                },
                {
                    "order": 3,
                    ...
                    "output_scope": "file"  # Word docs are file-level
                }
            ]
        })
            ...
            "steps": [
                {
                    ...
                    "status": "success",
                    "manifest_file": "assets/catalogue/catalogue_manifest.jsonl",
                    "output_scope": "folder"  # Folder catalogue is folder-level
                }
            ]
        })
            ...
            "steps": [
                {
                    ...
                    "output_scope": "file"  # Enhanced images are file-level
                }
            ]
        })
    ...
    def test_error_recovery_scenarios(self):
        ...
        with self.assertLogs(level='WARNING') as log:
            ...
            # Should handle gracefully and log warning or error about collection_id
            all_messages = [record.getMessage() for record in log.records]
            collection_messages = [msg for msg in all_messages if 'collection_id' in msg.lower()]
            self.assertTrue(any(collection_messages), "Should log warning/error about missing collection_id")
    ...
    def test_folder_processing_with_item_map(self):
        ...
        # Note: output_scope is required for proper routing (file-level vs folder-level)
        self._create_workflow_manifest(folder_output_dir, {
            "plan_name": "Transcribir y Catalogar",
            "workflow_name": "Catalogue",
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "status": "success",
                    "manifest_file": "assets/catalogue/catalogue_manifest.jsonl",
                    "output_scope": "folder"  # Catalogue is folder-level
                }
            ]
        })
