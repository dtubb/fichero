...
NEW_FILES=(
    "fichero-swiftui/fichero-swiftui/Models/LayoutMode.swift"
    "fichero-swiftui/fichero-swiftui/Models/ItemTypeRegistry.swift"
    "fichero-swiftui/fichero-swiftui/Views/Menu/AddItemMenu.swift"
    "fichero-swiftui/fichero-swiftui/Views/Toolbar/MainToolbar.swift"
)
...
echo "   - fichero-swiftui/fichero-swiftui/Models/LayoutMode.swift"
echo "   - fichero-swiftui/fichero-swiftui/Models/ItemTypeRegistry.swift"
echo ""
echo "4. Right-click 'Views/Menu' folder (or create 'Menu' folder if it doesn't exist)"
echo "5. Add: fichero-swiftui/fichero-swiftui/Views/Menu/AddItemMenu.swift"
echo ""
echo "6. Right-click 'Views' folder and create 'Toolbar' subfolder if it doesn't exist"
echo "7. Add: fichero-swiftui/fichero-swiftui/Views/Toolbar/MainToolbar.swift"
echo ""
echo "IMPORTANT:"
