...
class CollectionBottomToolbar(BottomToolbar):
    ...
    def __init__(self, app, is_mobile: bool = None):
        ...
        self.on_add_clicked: Optional[Callable] = None
    ...
    def clear_buttons(self):
        ...
        try:
            ...
            logger.debug("Collection bottom toolbar buttons cleared")
    ...
    def set_edit_mode(self, is_edit_mode: bool):
        ...
        try:
            if is_edit_mode:
                ...
                logger.info("Collection bottom toolbar set to edit mode - showing Add button")
            else:
                ...
                logger.info("Collection bottom toolbar set to normal mode - showing regular buttons")
    ...
    def _on_processing_clicked(self, widget):
        ...
        # Processing functionality would go here
    
    def _on_activity_monitor_clicked(self, widget):
        """Handle activity monitor button click"""
        logger.info("Activity monitor button clicked")
    ...
    def _on_about_clicked(self, widget):
        ...
        # About functionality would go here
    
    def _on_collection_settings_clicked(self, widget):
        """Handle collection settings button click"""
        logger.info("Collection settings button clicked")
