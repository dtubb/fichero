...
from fichero.director.monitoring.task_monitor import TaskMonitor, TaskInfo
...
try:
    from fichero.director.activity_monitor.base import GlobalActivityMonitor, GlobalTaskInfo, BackendInfo
    LEGACY_ACTIVITY_MONITOR_AVAILABLE = True
except ImportError:
    LEGACY_ACTIVITY_MONITOR_AVAILABLE = False

try:
    from fichero.director.progress_tracker.base import CoreProgressTracker, ProgressStage, TaskProgress
