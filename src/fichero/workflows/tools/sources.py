...
@register_tool(
    ...
    config_schema={
        "collection_id": {"type": "string", "description": "Collection ID to process"},
        "recursive": {"type": "boolean", "default": True, "description": "Include files from subfolders"},
        "file_types": {"type": "array", "items": {"type": "string"}, "description": "Filter by file types (image, pdf, etc.)"},
        "status_filter": {"type": "string", "enum": ["all", "pending", "completed"], "default": "all"},
        "limit": {"type": "integer", "default": 0, "description": "Max files (0 = no limit)"},
    },
    sort_order=2,
)
...
@register_tool(
    ...
    config_schema={
        "folder_id": {"type": "string", "description": "Folder ID to process"},
        "folder_path": {"type": "string", "description": "Alternative: folder path within collection"},
        "include_subfolders": {"type": "boolean", "default": False, "description": "Include files from subfolders"},
...
@register_tool(
    ...
    config_schema={
        ...
        "collection_id": {"type": "string", "description": "Optional: limit to collection"},
        "file_types": {"type": "array", "items": {"type": "string"}, "description": "Filter by file types"},
        "status_filter": {"type": "string", "enum": ["all", "pending", "completed"], "default": "all"},
        "min_score": {"type": "number", "default": 0.0, "description": "Minimum relevance score"},
