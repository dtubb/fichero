...
// EntityService is large (many /api/entities + /api/claims endpoint
// wrappers). Responsibility-split into EntityService+*.swift extensions is
// the follow-up; disable is honest interim debt, not a hidden suppression.
