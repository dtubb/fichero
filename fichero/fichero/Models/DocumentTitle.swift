...
enum DocumentTitle {
    ...
    static func windowTitle(
        ...
        // No count branch (Daniel, 2026-08-23): the title names WHERE you
        // are; the status island owns "N of M selected". Composing a count
        // here is how "3 images" and "3 selected" showed at once.
