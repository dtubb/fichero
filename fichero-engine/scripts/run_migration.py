...
Usage:
    ...
    PYTHONPATH=fichero-engine/src python fichero-engine/scripts/run_migration.py list

    # Dry-run a migration (validate without changing data)
    PYTHONPATH=fichero-engine/src python fichero-engine/scripts/run_migration.py \
