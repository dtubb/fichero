...
run_check "Pylint (errors only)" env PYTHONPATH=fichero-engine/src "$PYTHON_BIN" -m pylint --rcfile=fichero-engine/.pylintrc --errors-only fichero-engine/src/fichero fichero-engine/src/fichero_engine
