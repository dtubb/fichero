...
# FoundationModels to Python via subprocess. See main.swift for protocol.
#
# Usage: ./build.sh
# Or from repo root: fichero-engine/bin/fm-bridge/build.sh
...
swiftc -O -parse-as-library -o fm-bridge main.swift
