"""fichero.api.routes.search package — search.py moved to search/core.py (#2569)."""
from fichero.api.routes.search.core import *  # noqa
...
from fichero.api.routes.search.core import (  # noqa: F401
