...
from fichero.api.routes.research_crud import router as crud_router
from fichero.api.routes.research_notes import router as notes_router
from fichero.api.routes.research_tools import router as tools_router
