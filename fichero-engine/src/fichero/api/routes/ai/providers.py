...
from fichero.api.routes.ai.provider_models import (  # noqa: F401 (re-exported for tests)
...
from fichero.api.routes.ai.provider_keys import router as keys_router
