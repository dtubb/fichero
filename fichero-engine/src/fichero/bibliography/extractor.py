...
``fichero.bibliography.doi_lookup.resolve_doi(doi)`` after this to
enrich the result.
"""
...
def _gather_cover_pages_text(document: "Document", n_pages: int = 4) -> str:
    ...
    try:
        ...
        from fichero.models import Document as DocModel
...
async def extract_from_first_pages(
    ...
    from fichero.llm import chat_structured_with_fallback
