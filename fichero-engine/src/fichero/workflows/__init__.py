...
if TYPE_CHECKING:  # pragma: no cover - import-time typing only
    from fichero.workflows.types import State, NodeDef, EdgeDef, WorkflowDef, ToolDef
...
# this package — even `fichero.workflows.types.State`, a plain dataclass — ran
...
def __getattr__(name: str) -> Any:
    ...
    module = importlib.import_module(f"fichero.workflows.{module_name}")
