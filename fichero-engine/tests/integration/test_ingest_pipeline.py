...
class TestIngestPipelineIntegration:
    ...
    def _setup_mocks(self):
        ...
        return mock_db, mock_bookmark, mock_shutil
    ...
    def test_complete_folder_ingestion_workflow(self, tmp_path):
        ...
        mock_db, mock_bookmark, mock_shutil = self._setup_mocks()
        
        # Mock database before importing ingest module
        with patch("fichero.db.db", mock_db):
            with patch("fichero.bookmarks.create_bookmark", mock_bookmark):
                with patch("fichero.ingest.shutil", mock_shutil):
    ...
    def test_copy_mode_with_apfs_cloning(self, tmp_path):
        ...
        with patch("fichero.db.db") as mock_db:
            ...
            with patch("fichero.ingest._try_apfs_clone") as mock_clone:
                ...
                # Mock settings
                with patch("fichero.ingest.settings") as mock_settings:
    ...
    def test_error_handling_mixed_files(self, tmp_path):
        ...
        with patch("fichero.db.db") as mock_db:
            ...
            # Mock bookmark creation to fail for one file
    ...
    def test_database_integration(self, tmp_path):
        ...
        with patch("fichero.db.db") as mock_db:
            ...
            with patch("fichero.bookmarks.create_bookmark") as mock_bookmark:
                ...
                assert mock_db.save.call_count >= 3  # Collection + 2 files
    ...
    def test_duplicate_detection(self, tmp_path):
        ...
        with patch("fichero.db.db") as mock_db:
            ...
            with patch("fichero.bookmarks.create_bookmark") as mock_bookmark:
                ...
                assert docs[0].name == "file1.jpg"
                assert docs[1].name == "file2.jpg"
    ...
    def test_permission_error_handling(self, tmp_path):
        ...
        with patch("fichero.db.db") as mock_db:
            ...
            # Mock bookmark creation to raise permission error for restricted file
            def mock_bookmark_side_effect(path):
