...
- The LLM boundary (``fichero.llm.chat_structured_with_fallback``) and the layer
...
def test_extract_from_first_pages_maps_llm_result(monkeypatch):
    ...
    # The function imports chat_structured_with_fallback from fichero.llm locally.
    import fichero.llm as llm_mod
