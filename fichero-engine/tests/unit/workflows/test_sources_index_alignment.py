...
async def test_collection_tool_nonselected_file_paths_doc_data_aligned():
    ...
    with (
        patch("fichero.workflows.tools.sources.db_manager") as mock_dbm,
        patch(
            "fichero.workflows.tools.sources._get_files_in_folder",
...
async def test_collection_tool_selected_two_pages_same_pdf_both_entries():
    ...
    with (
        patch("fichero.workflows.tools.sources.db_manager") as mock_dbm,
        patch(
            "fichero.workflows.tools.sources._resolve_page_to_parent",
