...
def test_resume_argument_uses_command_for_human_answer():
    from fichero.api.routes.workflow_execution.core import _resume_argument
    from fichero.api.routes.workflow_execution.schemas import ResumeWorkflowRequest
