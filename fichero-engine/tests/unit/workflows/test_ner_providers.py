...
from fichero.kg.ner import ExtractedEntity
from fichero.workflows.ner.providers import (
    LLMNERProvider,
    SpacyNERProvider,
    TransformersNERProvider,
    get_ner_provider,
)
from fichero.workflows.tools.ner import ner
...
def test_llm_provider_flattens_entity_payload(monkeypatch):
    ...
    monkeypatch.setattr(
        "fichero.workflows.tools.entities.extract_entities",
...
def test_ner_tool_serializes_selected_provider(monkeypatch):
    ...
    monkeypatch.setattr(
        "fichero.workflows.ner.providers.get_ner_provider",
