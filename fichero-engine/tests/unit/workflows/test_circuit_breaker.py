...
from fichero.llm import ProviderQuotaError
...
def no_sleep(monkeypatch):
    ...
    monkeypatch.setattr(
        "fichero.workflows.circuit_breaker.asyncio.sleep", _fake_sleep
    )
    return delays
...
async def test_semaphore_released_during_backoff_sleep(monkeypatch):
    ...
    monkeypatch.setattr(
        "fichero.workflows.circuit_breaker.asyncio.sleep", _observing_sleep
    )
