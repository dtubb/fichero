---
description: Design and implement a feature flag system for this project. Reads the tech stack from CLAUDE.md and proposes an appropriate approach. Works for Swift, Python, or mixed projects.
name: feature-flags
---

# /feature-flags

Design a feature flag system that lets you toggle features on/off for dev vs release builds. Reads the tech stack from `CLAUDE.md` — adapts to Swift, Python, or any combination.
...
1. Create the flag file(s) in the right location per `CLAUDE.md`
