---
description: Create a pull request — runs quality checks, formats PR from conventions in CLAUDE.md, creates it via gh. Works for any project.
name: pr-workflow
---

# /pr-workflow

Create a pull request the right way. Reads conventions from `CLAUDE.md`. Runs `/build-and-test` first.
...
From `CLAUDE.md` or `.claude/CLAUDE.md`, find:
