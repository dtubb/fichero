---
description: Build, test, and lint the project. Reads commands from CLAUDE.md — works for any stack. Run before completing any code task.
name: build-and-test
---

# /build-and-test

Run the full quality cycle for this project. Commands come from `CLAUDE.md` — this skill adapts to any stack.

## Step 1 — Read the commands

Read `.claude/CLAUDE.md` or `CLAUDE.md`. Find the "Build / Test / Lint" or "How I Ship" section. Extract:
- Build command(s)
- Test command(s)
- Lint command(s)
