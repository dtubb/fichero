...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Library/ViewModes/Icon/LibraryMarquee.swift": "2026-08-31 — marquee autoscroll drives the enclosing NSScrollView's clip view directly; a SwiftUI scrollPosition write-back per frame re-renders the whole grid (the exact perf bug this fixes); #2101",
