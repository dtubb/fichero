...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Models/WorkflowStore.swift": "§6b baseline — pasteboard/AppKit",
    "Services/EmbeddedBackendService.swift": "§6b baseline — process/AppKit lifecycle",
    "Services/ImageEditingServiceGenerated.swift": "§6b baseline — NSImage codec",
    "Services/StorageServiceGenerated.swift": "§6b baseline — NSImage thumbnails",
    "Services/WorkflowServiceGenerated.swift": "§6b baseline — AppKit bridge",
    ...
    "Views/Library/AnnotationsInspectorPane.swift": "§6b baseline — AppKit",
