...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Inspector/Document/Artifacts/DocumentInspectorArtifactsTab+EntitiesTab.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Inspector/Document/Artifacts/DocumentInspectorArtifactsTab+KGSection.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    ...
    "Views/Reader/Page/ImmersiveReaderView.swift": "#2520 — immersive reader catches Esc via platform keyboard bridge; #2101",
    "Views/Preview/PDF/PDFPageView.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Preview/PDF/PDFThumbnailView.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Library/Workspace/LibraryWorkspaceRoot.swift": "#2713 — workspace root uses UIKit-only mobile affordances; #2101",
    "Views/Preview/QuickLook/QuickLookComponents.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Preview/QuickLook/QuickLookPreviewViews.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Shell/Menu/FileMenuCommands.swift": "#2713 — PDFKit page bridge (AppKit/UIKit via #if canImport); #2101",
    "Views/Shell/Menu/FocusedCommandButtons.swift": "#2713 — command buttons use macOS focus-key equivalents via AppKit; #2101",
