...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Inspector/Document/Knowledge/Entities/DocumentInspectorEntitiesTab+Menus.swift": "#2101 — AppKit via #if canImport (context-menu / pasteboard); split from DocumentInspectorEntitiesTab",
    "Views/Inspector/Document/Knowledge/Entities/DocumentInspectorEntitiesTab+SupportTypes.swift": "#2101 — AppKit via #if canImport (drag support types); split from DocumentInspectorEntitiesTab",
