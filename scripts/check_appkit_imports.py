...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Inspector/Document/Artifacts/Entities/DocumentInspectorEntitiesTab+Menus.swift": "#2101 — AppKit via #if canImport (context-menu / pasteboard); split from DocumentInspectorEntitiesTab",
    "Views/Inspector/Document/Artifacts/Entities/DocumentInspectorEntitiesTab+SupportTypes.swift": "#2101 — AppKit via #if canImport (drag support types); split from DocumentInspectorEntitiesTab",
