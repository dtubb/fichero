...
KNOWN_VIOLATIONS: dict[str, str] = dict.fromkeys(
    [
        ...
        "fichero/fichero/Views/Shell/Menu/FocusedCommandButtons+CreationActions.swift",
        "fichero/fichero/Views/Shell/Menu/FocusedCommandButtons+Workflow.swift",
        "fichero/fichero/Views/Shell/Menu/FocusedCommandButtons+UndoNavigation.swift",
