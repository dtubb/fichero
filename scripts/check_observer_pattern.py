...
KNOWN_VIOLATIONS: dict[str, str] = dict.fromkeys(
    [
        ...
        "fichero/fichero/Views/Workflow/DynamicConfigView.swift",
        "fichero/fichero/Views/Workflow/NodeConfigs/CollectionNodeConfig.swift",
        "fichero/fichero/Views/Workflow/NodeConfigs/ExtractEntitiesNodeConfig.swift",
        "fichero/fichero/Views/Workflow/NodeConfigs/FilesNodeConfig.swift",
