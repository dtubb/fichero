...
KNOWN_VIOLATIONS: dict[str, str] = dict.fromkeys(
    [
        ...
        "fichero/fichero/Views/Inspector/Document/Knowledge/EntityKindRow.swift",
        "fichero/fichero/Views/Inspector/Document/Notes/DocumentInterpretationsSection.swift",
