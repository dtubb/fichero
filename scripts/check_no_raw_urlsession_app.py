...
docs/contributor/architecture/fichero/raw_urlsession_audit_1666.md) and only via the pinned
...
AUDIT_DOC = "docs/contributor/architecture/fichero/raw_urlsession_audit_1666.md"
...
GRANDFATHERED_FILES: set[str] = {
    ...
    "Views/Reader/PDFLoupeOverlay.swift",
    "Views/Reader/PDFThumbnailView.swift",
