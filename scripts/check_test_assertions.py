...
# #4382: this pointed at fichero/fichero-cli, a path that has not existed
# since the reorg — the CLI tree was silently scanned as zero files while the
# guardrail stayed green. The blindness guard below is what exposed it.
CLI_ROOT = ROOT / "fichero-cli"
...
KNOWN_VACUOUS = {
    ...
    "fichero-server/tests/unit/models/test_change_stream.py::TestEmitChange::test_emit_change_never_raises",
    "fichero-server/tests/unit/scripts/test_db_access_guardrail.py::test_no_new_raw_db_access_outside_persistence_layer",
    ...
    "fichero-server/tests/unit/api/test_knowledge_graph_security.py::TestEntityAccessControl::test_claim_linking_prevents_cross_library",
    "fichero-server/tests/unit/api/test_knowledge_graph_security.py::TestEntityAccessControl::test_entity_access_requires_ownership_check",
    ...
    "fichero-server/tests/unit/security/test_path_security_roots.py::test_validate_clean_relative_path_is_trusted",
    "fichero-server/tests/unit/security/test_path_security_roots.py::test_validate_none_and_empty_are_noops",
    "fichero-server/tests/unit/security/test_path_security_roots.py::test_validate_relative_with_parent_ref_that_stays_inside",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateAPIBase::test_empty_url",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateAPIBase::test_valid_http_localhost",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateAPIBase::test_valid_https_url",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateAPIKeyFormat::test_anthropic_key_valid",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateAPIKeyFormat::test_openai_key_valid",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateProviderConfig::test_azure_with_valid_config",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateProviderConfig::test_local_provider_no_key_required",
    "fichero-server/tests/unit/llm/test_provider_validation.py::TestValidateProviderConfig::test_omlx_accepts_arbitrary_local_key",
...
if __name__ == "__main__":
    _require_scan_roots_4382(PY_TEST_ROOT, CLI_ROOT, SWIFT_ROOT)
