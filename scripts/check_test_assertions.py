...
KNOWN_VACUOUS = {
    ...
    "fichero-engine/tests/integration/test_api_contracts.py::TestExportedSchemaMatchesLive::test_exported_endpoints_match_live",
    "fichero-engine/tests/integration/test_api_contracts.py::TestOpenAPISchemaValidity::test_endpoints_have_operation_ids",
    "fichero-engine/tests/integration/test_api_contracts.py::TestSwiftCompatibility::test_date_formats_documented",
    "fichero-engine/tests/integration/test_api_contracts.py::TestSwiftCompatibility::test_response_models_are_serializable",
    "fichero-engine/tests/integration/test_contract_endpoint_walk.py::test_no_envelope_get_endpoint_returns_500",
    "fichero-engine/tests/integration/test_contract_endpoint_walk.py::test_no_new_bare_array_get_endpoint",
    "fichero-engine/tests/unit/test_bookmarks.py::TestStopAccessing::test_no_error_for_nonexistent_file",
    ...
    "fichero-engine/tests/unit/test_integration_security.py::TestLibraryPathSecurity::test_library_path_validates_allowed_locations",
    "fichero-engine/tests/unit/test_integration_security.py::TestSecurityHeaders::test_security_headers_present",
    "fichero-engine/tests/unit/test_knowledge_graph_security.py::TestEntityAccessControl::test_claim_linking_prevents_cross_library",
    "fichero-engine/tests/unit/test_knowledge_graph_security.py::TestEntityAccessControl::test_entity_access_requires_ownership_check",
    "fichero-engine/tests/unit/test_library_registry.py::TestLibraryAutoRegistration::test_create_library_auto_registers",
    "fichero-engine/tests/unit/test_mcp_manager.py::TestMCPManager::test_remove_nonexistent_server",
    "fichero-engine/tests/unit/test_model_profiles.py::test_enforce_allows_private_local_profile",
    "fichero-engine/tests/unit/test_model_profiles.py::test_enforce_allows_standard_cloud_profile",
    "fichero-engine/tests/unit/test_new_data_layer.py::test_db",
    "fichero-engine/tests/unit/test_ocr_geometry_helpers.py::test_bbox_edge_epsilon_tolerance",
    "fichero-engine/tests/unit/test_ocr_geometry_helpers.py::test_policy_allows_cloud_when_not_local_only",
    "fichero-engine/tests/unit/test_ocr_geometry_helpers.py::test_policy_allows_local_providers",
    "fichero-engine/tests/unit/test_path_security_roots.py::test_validate_clean_relative_path_is_trusted",
    "fichero-engine/tests/unit/test_path_security_roots.py::test_validate_none_and_empty_are_noops",
    "fichero-engine/tests/unit/test_path_security_roots.py::test_validate_relative_with_parent_ref_that_stays_inside",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateAPIBase::test_empty_url",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateAPIBase::test_valid_http_localhost",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateAPIBase::test_valid_https_url",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateAPIKeyFormat::test_anthropic_key_valid",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateAPIKeyFormat::test_openai_key_valid",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateProviderConfig::test_azure_with_valid_config",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateProviderConfig::test_local_provider_no_key_required",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateProviderConfig::test_omlx_accepts_arbitrary_local_key",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateProviderConfig::test_valid_anthropic_config",
    "fichero-engine/tests/unit/test_provider_validation_errors.py::test_clean_key_still_passes",
    "fichero-engine/tests/unit/test_provider_validation.py::TestValidateProviderConfig::test_valid_openai_config",
    "fichero-engine/tests/unit/test_research_ssrf_security.py::TestSSRFResourceLimits::test_web_search_timeout_enforced",
    "fichero-engine/tests/unit/test_storage.py::TestShutdown::test_shutdown_idempotent",
    "fichero-engine/tests/unit/test_transcription_save.py::TestParseJsonFieldsNullMetadata::test_null_metadata_does_not_raise_validation_error",
    "fichero-engine/tests/unit/test_vision_warning_activity.py::TestLogVisionWarning::test_no_tracker_does_not_raise",
    "fichero-engine/tests/unit/test_vision_warning_activity.py::TestLogVisionWarning::test_tracker_import_failure_falls_back_gracefully",
    "fichero-engine/tests/unit/test_vision_warning_activity.py::TestLogVisionWarning::test_tracker_log_exception_does_not_propagate",
    "fichero-engine/tests/unit/test_workflow_executor.py::test_tool",
    "fichero-engine/tests/unit/workflows/test_default_workflow_e2e_harness.py::test_catalogue_default_workflow_lands_artifacts_and_kg_rows",
    "fichero-engine/tests/unit/workflows/test_default_workflow_e2e_harness.py::test_catalogue_twostage_workflow_lands_kg_rows",
    "fichero-engine/tests/unit/workflows/test_ner_config_schema.py::test_extract_all_exposes_ner_provider_and_model",
    "fichero-engine/tests/unit/workflows/test_ner_config_schema.py::test_section_extractors_expose_ner_provider_and_model",
    "fichero-engine/tests/unit/test_backend_integration.py::TestIngestWithTextExtraction::test_ingest_file_skips_non_extractable",
    "fichero-engine/tests/unit/test_ingest_module.py::TestCopyToLibrary::test_falls_back_to_shutil",
    "fichero-engine/tests/unit/test_ingest_module.py::TestCopyToLibrary::test_uses_apfs_clone_when_available",
}
