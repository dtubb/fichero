...
KNOWN_VACUOUS = {
    ...
    "fichero-server/tests/unit/test_bookmarks.py::TestStopAccessing::test_no_error_for_nonexistent_file",
    "fichero-server/tests/unit/test_bookmarks.py::TestStopAccessing::test_no_error_for_regular_file",
    ...
    "fichero-server/tests/unit/test_integration_security.py::TestEnvironmentSecurity::test_api_key_required_in_production",
    "fichero-server/tests/unit/test_integration_security.py::TestLibraryPathSecurity::test_library_path_validates_allowed_locations",
    "fichero-server/tests/unit/test_integration_security.py::TestSecurityHeaders::test_security_headers_present",
    ...
    "fichero-server/tests/unit/test_mcp_manager.py::TestMCPManager::test_remove_nonexistent_server",
    ...
    "fichero-server/tests/unit/test_ocr_geometry_helpers.py::test_bbox_edge_epsilon_tolerance",
    "fichero-server/tests/unit/test_ocr_geometry_helpers.py::test_policy_allows_cloud_when_not_local_only",
    "fichero-server/tests/unit/test_ocr_geometry_helpers.py::test_policy_allows_local_providers",
    ...
    "fichero-server/tests/unit/test_ingest_module.py::TestCopyToLibrary::test_falls_back_to_shutil",
    "fichero-server/tests/unit/test_ingest_module.py::TestCopyToLibrary::test_uses_apfs_clone_when_available",
}
