...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "App/WelcomeView+OnboardingWizardActions.swift#72a4ce5c4a": "§6b baseline — raw URLSession",
    "App/WelcomeView+OnboardingWizardActions.swift#b4bd73e31d": "§6b baseline — hand-built URLRequest(url:)",
