...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/AIProviders/ProvidersSettingsSheet.swift": "#2955 — confirmed unreferenced sheet wrapper; frontend deletion pending manager verification",
    "Views/Actions/ActionPickerView.swift": "#1945 — candidate dead file: action picker helper types",
    "Views/Agents/AgentConfigurationView.swift": "#1945 — candidate dead file: agent configuration helper types",
    "Views/Agents/AgentSettingsView.swift": "#1945 — candidate dead file: agent settings helper types",
    ...
    "Views/Chat/ChatMapGrid.swift": "#2955 — confirmed unreferenced grid shape; frontend deletion pending manager verification",
    "Views/Components/ScheduleRow.swift": "#1945 — candidate dead file: ScheduleRow helpers",
    "Views/Components/TriggerRow.swift": "#1945 — candidate dead file: TriggerRow helpers",
    ...
    "Views/Integrations/IntegrationsView.swift": "#1945 — candidate dead file: IntegrationsView",
    ...
    "Views/Library/ScrollWheelZoom.swift": "#1945 — candidate dead file: scroll-wheel zoom bridge types",
    "Views/MCPServers/MCPToolsCatalogView.swift": "#1945 — candidate dead file: MCP tools catalog helper types",
    "Views/Menu/AddItemMenu.swift": "#2955 — confirmed unreferenced add-item menu wrapper; frontend deletion pending manager verification",
    "Views/Menu/ImagePreviewMenuCommands.swift": "#1945 — candidate dead file: MagnifierLimits",
    "Views/Notes/NotesBrowserView.swift": "#2955 — confirmed unreferenced notes browser surface; frontend deletion pending manager verification",
    ...
    "Views/Toolbars/MiniToolbarComponents.swift": "#2955 — confirmed unreferenced mini-toolbar helper views; frontend deletion pending manager verification",
