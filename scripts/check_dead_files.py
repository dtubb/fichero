...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Library/ViewModes/Ontology/ClaimSummaryCard+Provenance.swift": "#1945 — candidate dead file: ProvenanceBadge",
    "Views/Library/ViewModes/Ontology/EntityDetailView+Biography.swift": "#1945 — candidate dead file: MentionSummary",
    "Views/Library/ViewModes/Ontology/OntologyBrowser+Toolbar.swift": "#1945 — candidate dead file: EntityKindChip",
