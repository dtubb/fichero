...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/ContentView+Actions.swift": "#1945 — candidate dead file: ChatScopeBuilder",
    ...
    "Views/Library/LibraryView+KeyboardShortcuts.swift": "#1945 — candidate dead file: shortcut key/helper types",
    ...
    "Views/Toolbars/SearchViewToolbar.swift": "#1945 — candidate dead file: SearchViewToolbar",
