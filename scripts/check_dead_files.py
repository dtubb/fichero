...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Views/Library/ViewModes/Graph/Ontology/ClaimSummaryCard+Provenance.swift": "#1945 — candidate dead file: ProvenanceBadge",
    "Views/Library/ViewModes/Graph/Ontology/EntityDetailView+Biography.swift": "#1945 — candidate dead file: MentionSummary",
    ...
    "Views/Preview/PDF/PageImageGrid.swift": "#1945 — candidate dead file: page image grid helper types",
