...
KNOWN_GAPS: dict[str, str] = {
    ...
    'GET /api/users': "#2022 multi-user backend - cli-only, frontend deferred",
    'PATCH /api/users/{user_id}': "#2022 multi-user backend - cli-only, frontend deferred",
    'POST /api/users': "#2022 multi-user backend - cli-only, frontend deferred",
    'GET /api/auth/me': "#2022 multi-user backend - cli-only, frontend deferred",
    'POST /api/auth/login': "#2022 multi-user backend - cli-only, frontend deferred",
    'POST /api/auth/logout': "#2022 multi-user backend - cli-only, frontend deferred",
    ...
    'PATCH /api/citations/graph/{citation_id}': "#1920 baseline - cli-only",
    ...
    'POST /api/documents/{doc_id}/restore': "#2075 backend; UI tracked in #2077",
    ...
    'GET /api/local-inference/catalog': "#1814 backend local-MLX control surface; Mac/SwiftUI wiring deferred",
    'GET /api/local-inference/profiles': "#1814 backend local-MLX control surface; Mac/SwiftUI wiring deferred",
    'GET /api/local-inference/profiles/{profile_id}/status': "#1814 backend local-MLX control surface; Mac/SwiftUI wiring deferred",
    ...
    'POST /api/local-inference/profiles/{profile_id}/start': "#1814 backend local-MLX control surface; Mac/SwiftUI wiring deferred",
    'POST /api/local-inference/profiles/{profile_id}/stop': "#1814 backend local-MLX control surface; Mac/SwiftUI wiring deferred",
    ...
    'POST /api/mind-palace/connections': "#1920 baseline - cli-only",
    'DELETE /api/mind-palace/connections/{connection_id}': "#1920 baseline - cli-only",
    'POST /api/mind-palace/export/tinderbox': "#1920 baseline - cli-only",
    'POST /api/mind-palace/import/tinderbox': "#1920 baseline - cli-only",
    'DELETE /api/mind-palace/nodes/{node_id}': "#1920 baseline - cli-only",
    'GET /api/mind-palace/nodes/{node_id}': "#1920 baseline - cli-only",
    'GET /api/mind-palace/notes': "#1920 baseline - cli-only",
    'POST /api/mind-palace/notes': "#1920 baseline - cli-only",
    'DELETE /api/mind-palace/notes/{note_id}': "#1920 baseline - cli-only",
    'GET /api/mind-palace/notes/{note_id}': "#1920 baseline - cli-only",
    'PATCH /api/mind-palace/notes/{note_id}': "#1920 baseline - cli-only",
    'POST /api/mind-palace/folders/{folder_id}/arrange': "#2297 arrange - backend/cli, Swift Arrange menu deferred",
    'GET /api/mind-palace/folders/{folder_id}/canvas-items': "#2294 canvas items - backend/cli, Swift canvas UI deferred (Slice 2)",
    'POST /api/mind-palace/folders/{folder_id}/canvas-items': "#2294 canvas items - backend/cli, Swift canvas UI deferred (Slice 2)",
    'PATCH /api/mind-palace/folders/{folder_id}/canvas-items/{item_id}': "#2294 canvas items - backend/cli, Swift canvas UI deferred (Slice 2)",
    'DELETE /api/mind-palace/folders/{folder_id}/canvas-items/{item_id}': "#2294 canvas items - backend/cli, Swift canvas UI deferred (Slice 2)",
    'DELETE /api/mind-palace/rooms/{room_id}': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/connections': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/nodes': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/rooms': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/rooms/{room_id}/viewport/{user_id}': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/stacks': "#2297 sweep baseline - cli-only",
    'PATCH /api/mind-palace/nodes/{node_id}': "#2297 sweep baseline - cli-only",
    'POST /api/mind-palace/nodes': "#2297 sweep baseline - cli-only",
    'POST /api/mind-palace/rooms': "#2297 sweep baseline - cli-only",
    'POST /api/mind-palace/rooms/{room_id}/suggest-arrangement': "#2297 sweep baseline - cli-only",
    'POST /api/mind-palace/rooms/{room_id}/viewport/{user_id}': "#2297 sweep baseline - cli-only",
    'POST /api/storage/regenerate-missing': "#2297 sweep baseline - cli-only",
    'GET /api/mind-palace/rooms/{room_id}': "#1920 baseline - cli-only",
    'PATCH /api/mind-palace/rooms/{room_id}': "#1920 baseline - cli-only",
    'POST /api/mind-palace/rooms/{room_id}/capture': "#1920 baseline - cli-only",
    'POST /api/mind-palace/rooms/{room_id}/focus': "#1920 baseline - cli-only",
    'GET /api/mind-palace/rooms/{room_id}/scene': "#1920 baseline - cli-only",
    'POST /api/mind-palace/stacks': "#1920 baseline - cli-only",
    'GET /api/mind-palace/stacks/{stack_id}': "#1920 baseline - cli-only",
    'DELETE /api/mind-palace/stacks/{stack_id}/nodes/{node_id}': "#1920 baseline - cli-only",
    'POST /api/mind-palace/stacks/{stack_id}/nodes/{node_id}': "#1920 baseline - cli-only",
    'POST /api/mindpalace/render': "#1920 baseline - cli-only",
    'POST /api/model-comparison/compare-node/apply': "#1920 baseline - cli-only",
    'GET /api/notes/{note_id}': "#1920 baseline - cli-only",
    'GET /api/notes/{note_id}/backlinks': "#1920 baseline - cli-only",
    'GET /api/notes/{note_id}/forward-links': "#1920 baseline - cli-only",
    ...
    'POST /api/storage/snapshots/{snapshot_id}/restore': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/health': "#1920 baseline - dead",
    'POST /api/tasks/tasks/kg-metrics': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/kg-metrics/{task_id}/data': "#1920 baseline - cli-only",
    'POST /api/tasks/tasks/metrics': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/metrics/{task_id}/data': "#1920 baseline - cli-only",
    'POST /api/tasks/tasks/reindex': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/reindex/{task_id}/progress': "#1920 baseline - cli-only",
    'POST /api/tasks/tasks/vector-repair': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/vector-repair/{task_id}/progress': "#1920 baseline - cli-only",
    'DELETE /api/tasks/tasks/{task_id}': "#1920 baseline - cli-only",
    'GET /api/tasks/tasks/{task_id}': "#1920 baseline - cli-only",
    'POST /api/tasks/tasks/{task_id}/cancel': "#1920 baseline - cli-only",
