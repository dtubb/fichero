...
KNOWN_GAPS: dict[str, str] = {
    ...
    'GET /api/kg/query/examples': "#1920 baseline - cli-only",
    ...
    'GET /api/storage/debug/{doc_id}': "#1920 baseline - dead endpoint",
    'GET /api/workflow-execution/stream/{thread_id}': "#1920 baseline - dead endpoint",
    ...
    'POST /api/annotations/crop': "#1920 baseline - cli-only",
    ...
    'POST /api/kg/query/sparql': "#1920 baseline - cli-only",
