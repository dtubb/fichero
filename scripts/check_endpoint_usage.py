...
KNOWN_GAPS: dict[str, str] = {
    ...
    'POST /api/pair/enroll': "#3789 zero-touch enrollment - cli-only; SwiftUI keychain-sync pairing wiring pending",
    ...
    'POST /api/registry/attach-bookmark': "#3773 runtime library attach - cli-only; SwiftUI host mint+transmit is the pending #3773 Swift half",
    ...
    'GET /api/tasks/tasks/health': "doubled tasks-router prefix bug tracked in #3755",
    ...
    'DELETE /api/users/{user_id}': "#3859 owner delete-user - cli-only; SwiftUI delete wiring pending (UsersSettingsView follow-up)",
