...
KNOWN_GAPS: dict[str, str] = {
    'GET /api/documents/{doc_id}/effective-attributes': "2026-08-12 datasets Stage 1 - Swift inspector wiring is the next commit",
    'GET /api/classifications/resolved/{key}': "2026-08-12 datasets Stage 1 - prototype editor wiring is the next commit",
    'GET /api/workflow-execution/threads/{thread_id}/episodes': "2026-08-12 episode ledger - per-run inspection UI queued",
    ...
    'POST /api/documents/{doc_id}/duplicate': "audited document.duplicate action (#4102): SwiftUI drives it via POST /api/actions/invoke, so only the CLI hits the raw path",
    ...
    'GET /api/migrations': "#1920 baseline - cli-only",
    'GET /api/migrations/integrity-check': "#1920 baseline - cli-only",
    'POST /api/migrations/rollback': "#1920 baseline - cli-only",
    'POST /api/migrations/run': "#1920 baseline - cli-only",
    'GET /api/migrations/status/{run_id}': "#1920 baseline - cli-only",
    'POST /api/migrations/validate': "#1920 baseline - cli-only",
    ...
    'GET /api/stats': "#1920 baseline - cli-only (inline main.py doc/artifact/embedding counts)",
