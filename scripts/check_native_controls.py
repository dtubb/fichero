...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Library/ViewModes/LibraryView+ListView.swift#19c3b271df": "#1912 baseline (list ScrollView+LazyVStack moved here when LibraryView+DisplayModes was split by file_length; rehashed: #3705 .draggable; #3875 selection-fill; #3868 extracted a value-typed selectable row wrapper; the collection itself is unchanged)",
