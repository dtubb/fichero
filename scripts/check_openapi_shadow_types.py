...
CONTRACT_OPENAPI = ROOT / "fichero-server" / "tests" / "contracts" / "openapi.json"
...
KNOWN_VIOLATIONS: dict[str, str] = {
    "Models/Run.swift::RunStatus": "#4316 — the server now exports the canonical RunStatus enum through OpenAPI; the app's hand-rolled enum predates it and is replaced by the generated one in the deferred Swift adoption pass (server-side-only tonight per the issue)",
    ...
    "Models/SearchResponse.swift::SearchResponse": "§6b baseline — struct shadows Components.Schemas.SearchResponse (moved out of Document.swift by file_length)",
    "Models/SearchResult.swift::SearchResult": "§6b baseline — struct shadows Components.Schemas.SearchResult (moved out of Document.swift by file_length)",
    ...
    "Views/Settings/AI/AIDefaults.swift::AIDefaults": "§6b baseline — struct shadows Components.Schemas.AIDefaults",
