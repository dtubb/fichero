...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "Models/Document.swift::HealthResponse": "§6b baseline — struct shadows Components.Schemas.HealthResponse",
    ...
    "Services/ActionInvokeService.swift::InvokeActionRequest": "§6b baseline — struct shadows Components.Schemas.InvokeActionRequest",
    ...
    "Services/ChatService.swift::ConversationSummary": "§6b baseline — struct shadows Components.Schemas.ConversationSummary",
    ...
    "Services/ModelService.swift::HFModelInfo": "§6b baseline — struct shadows Components.Schemas.HFModelInfo",
    "Services/ModelService.swift::HFTaskCategory": "§6b baseline — struct shadows Components.Schemas.HFTaskCategory",
    ...
    "Views/Library/WorkspaceItemPicker.swift::WorkspaceCuratedItem": "§6b baseline — struct shadows Components.Schemas.WorkspaceCuratedItem",
