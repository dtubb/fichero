...
KNOWN_VIOLATIONS: dict[str, str] = {
    ...
    "3bb1d5dfba43": '[notif] fichero/fichero/Views/Library/DocumentInspector.swift:46: .onReceive(NotificationCenter.default.publisher(for: .ficheroOpenClaimSource)) { note in',
    ...
    "b640d926df20": '[notif] fichero/fichero/Views/Library/PageContentPane.swift:224: .onReceive(NotificationCenter.default.publisher(for: .ficheroNavigateToPage)) { note in',
    "8dcea46c48f4": '[shared] fichero/fichero/Views/Agents/AgentSettingsView.swift:9: @StateObject private var settings = AgentSettings.shared',
    "bea02772db2d": '[shared] fichero/fichero/Views/Library/DocumentInspector.swift:20: @ObservedObject private var featureManager = FeatureManager.shared',
    "6faed3fc75b4": '[shared] fichero/fichero/Views/Library/DocumentInspector/DocumentInspectorAnnotationsTab.swift:8: @ObservedObject private var claimFocusState = ClaimFocusState.shared',
    ...
    "346f285358f1": '[shared] fichero/fichero/Views/Library/LibraryView.swift:106: @ObservedObject var workflowRunProviderCache = WorkflowRunProviderCache.shared',
    ...
    "931e0b0689d2": '[shared] fichero/fichero/Views/Menu/FileMenuCommands.swift:118: @ObservedObject private var registry = KnownLibraryRegistryStore.shared',
    ...
    "c46662138b3f": '[shared] fichero/fichero/Views/Onboarding/FirstRunWindow.swift:11: @ObservedObject private var libraryManager = LibraryManager.shared',
    ...
    "0dbf38641b72": '[shared] fichero/fichero/Views/Sidebar/SidebarItemRow.swift:107: @ObservedObject var workflowRunProviderCache = WorkflowRunProviderCache.shared',
    ...
    "c2b024572d9d": '[shared] fichero/fichero/Views/Toolbars/MiniToolbarComponents.swift:217: @ObservedObject private var featureManager = FeatureManager.shared',
    "3e8a3ffcc7f4": '[shared] fichero/fichero/Views/Toolbars/WorkflowToolbar.swift:19: @ObservedObject var featureManager = FeatureManager.shared',
    "8d2ad03f829a": '[shared] fichero/fichero/Views/Workflow/NodePopover.swift:29: @ObservedObject var featureManager = FeatureManager.shared',
    "87946124a99a": '[shared] fichero/fichero/Views/Workflow/WorkflowEditor.swift:42: @ObservedObject var featureManager = FeatureManager.shared',
    ...
    "1b6ce9d35fc1": '[shared] fichero/fichero/Views/Workflow/WorkflowNodeView.swift:16: @ObservedObject private var featureManager = FeatureManager.shared',
}
