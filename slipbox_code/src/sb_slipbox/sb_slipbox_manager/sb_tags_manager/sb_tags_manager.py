# src/sb_slipbox_manager/sb_tags_manager/sb_tags_manager.py

from src.common import *
import os

class sb_tags_manager():
  ...
  def __init__(self, slipbox_manager):
    ...
    log_and_print(f"Initializing Tags Manager at {self.directory}",
    ...
    if not os.path.exists(self.directory):
      ...
      log_and_print(f"Creating Tags folder at {self.directory}",
                  LOG_LEVELS.INFO, VERBOSITY_LEVELS.INFO)
                  

    log_and_print(f"Done Initializing Tags Manager",
                  LOG_LEVELS.INFO, VERBOSITY_LEVELS.INFO)
