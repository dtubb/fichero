...
You can read documentation here [`docs/user/`](docs/user/) for users.
...
Fichero has been coded over the last two years almost entirely by Claude, Codex, Glm 5.2, and other Frontier AI models. It is a work in progress, and it is open source. If you would like to contribute, please read the contributor documentation here [`docs/contributor/`](docs/contributor/).
