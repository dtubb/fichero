    ...
    var body: some View {
            ...
            ScrollViewReader { proxy in
                LazyVStack(spacing: 0) {
                    ...
                    SidebarSectionView(
                        ...
                        isDropTargeted: $isChatDropTargeted
                    )
                    ...
                    SidebarSectionView(
                        ...
                        isDropTargeted: .constant(false),
                        showNewItemButton: true,
                        newItemAction: { createNewWorkflow() }
                    )
                }
                .background(
        ...
        .onDisappear {
            ...
            if let result = performanceService.stopFrameRateMonitoring("sidebar") {
                logger.info("Sidebar frame rate: {\(result.averageFPS)} FPS over {\(result.frameCount)} frames")
            }
