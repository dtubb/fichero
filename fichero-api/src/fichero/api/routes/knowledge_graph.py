...
# =============================================================================
# Contradiction Evidence API (Issue #436)
# =============================================================================
...
async def get_contradiction_evidence(
    ...
    # Get all links where this claim contradicts or is contradicted
    links = db.query(KnowledgeClaimLink, claim_id=claim_id)
    reverse_links = db.query(KnowledgeClaimLink, related_claim_id=claim_id)
            ...
            if (link.link_quality or 0) >= min_link_quality:
                ...
                if other:
                    ...
                    if other.source_metadata:
                        source_meta = other.source_metadata.model_dump() if hasattr(other.source_metadata, "model_dump") else dict(other.source_metadata)

                    contradicting.append(
                        ContradictingClaimItem(
                            claim_id=other.id,
                            text=other.text[:500],
                            epistemic_status=other.epistemic_status.value if other.epistemic_status else None,
