...
- 0.0.3 issue **#420** — reindex/repair jobs — **COMPLETE** (task router registered, tests pass)
- Unit backend test suite: **1228 passed, 21 skipped**

## In Progress

1. Backend-only execution of open milestone issues:
   - **0.0.3:** ~~#419~~ ✅, ~~#420~~ ✅, **#421** (next), #422
...
1. Claim and start **#421** (0.0.3 — Multilingual Baseline for Claims / Entities and Cross-Language Retrieval).
