...
All four planned phases complete. Branch `0.0.2` is clean and pushed. Ready for Daniel to test and release.
...
Branch is green. Things to test before considering 0.0.2 ready for release:
...
Release checklist issues (#157–#165 in GitHub):
